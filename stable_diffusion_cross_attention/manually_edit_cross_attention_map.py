...
cv2.imwrite("generated.png", image[0, :, :, ::-1])
attention_map = show_cross_attention(controller, res=16, from_where=("up", "down"))
cv2.imwrite("attention_map.png", attention_map.reshape(-1, len(tokenizer.encode(prompts[0])) * 256, 3))